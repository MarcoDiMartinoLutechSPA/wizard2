		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tutorial",
									"targetURL": "#sapbtpwizard2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpwizard2-display": {
								"semanticObject": "sapbtpwizard2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.wizard2",
									"url": sap.ui.require.toUrl("sap/btp/wizard2")
								}
							}
						}
					}
